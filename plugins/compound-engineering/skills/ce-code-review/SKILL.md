...
- Interactive mode may offer to externalize residual actionable work via `references/tracker-defer.md` (named tracker -> GitHub Issues -> harness task primitive), but it is not required to finish the review.
